...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_SUBGRAPH_URL_MAINNET: z.string().url(),
    NEXT_PUBLIC_SUBGRAPH_URL_SEPOLIA: z.string().url(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_IS_MAINNET: process.env.NEXT_PUBLIC_CHAIN_ID === "1",
    ...
    NEXT_PUBLIC_SUBGRAPH_URL_MAINNET:
      process.env.NEXT_PUBLIC_SUBGRAPH_URL_MAINNET,
    NEXT_PUBLIC_SUBGRAPH_URL_SEPOLIA:
      process.env.NEXT_PUBLIC_SUBGRAPH_URL_SEPOLIA,
